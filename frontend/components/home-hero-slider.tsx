      ...
      <div className="content-shell mx-auto w-full px-4 py-12 sm:px-6 lg:px-12 lg:py-16">
        <div className="relative min-h-128 w-full overflow-hidden border-2 border-black sm:min-h-144 lg:min-h-168">
          {heroSlides.map((slide, index) => (
            ...
            >
              <div className="flex h-full w-full flex-col justify-center px-6 py-12 text-white sm:px-10 lg:px-14">
          ...
          <div className="absolute bottom-6 left-1/2 z-20 flex -translate-x-1/2 items-center gap-3">
            {heroSlides.map((slide, index) => (
              <button
                ...
                className={`h-3 w-3 border-2 border-white transition-opacity focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white ${
